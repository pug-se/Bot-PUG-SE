...
class TestUtilsDatabaseCache(unittest.TestCase):
    ...
    @patch("pugsebot.utils.database.Cache.get")
    ...
    @patch("pugsebot.utils.database.Cache.create")
    @patch("pugsebot.utils.database.Cache.get")
...
class TestUtilsDatabaseCommandInfo(unittest.TestCase):
    ...
    @patch("pugsebot.utils.database.CommandInfo.get")
    def test_get_value_valid(self, get):
    ...
    @patch("pugsebot.utils.database.CommandInfo.create")
    @patch("pugsebot.utils.database.CommandInfo.get")
